...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_GALAXYS2_FR)
extern struct cpufreq_governor cpufreq_gov_galaxys2_fr;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_galaxys2_fr)
